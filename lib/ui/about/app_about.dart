...
/// Opens the standard About dialog: the diary-not-a-device statement plus the
/// built-in licences page (which lists the bundled Hanken font's OFL, registered
/// in `main.dart`).
void showAppAbout(BuildContext context) {
  ...
  showAboutDialog(
    ...
    children: [Text(l10n.disclaimerBody)],
  );
}
